...
session4 = Session.create(start_time: "2018-01-01 10:00", end_time: "2018-01-01 10:30", distance: 2.3)
session5 = Session.create(start_time: "2018-01-01 10:00", end_time: "2018-01-01 10:30", distance: 5.0)
session6 = Session.create(start_time: "2018-01-01 10:00", end_time: "2018-01-01 10:30", distance: 2.5)
session7 = Session.create(start_time: "2018-01-01 10:00", end_time: "2018-01-01 10:30", distance: 1.3)
...
UsersSession.create(user: graham, session: session1)
UsersSession.create(user: khaled, session: session1)
UsersSession.create(user: jenny, session: session2)
UsersSession.create(user: joseph, session: session2)
UsersSession.create(user: adam, session: session2)
UsersSession.create(user: paul, session: session2)
UsersSession.create(user: sergio, session: session2)
UsersSession.create(user: graham, session: session3)
UsersSession.create(user: aicha, session: session3)
UsersSession.create(user: charlie, session: session4)
UsersSession.create(user: christina, session: session4)
UsersSession.create(user: david, session: session4)
UsersSession.create(user: heejae, session: session5)
UsersSession.create(user: mickey, session: session5)
UsersSession.create(user: kailey, session: session5)
UsersSession.create(user: nick, session: session6)
UsersSession.create(user: sergio, session: session6)
UsersSession.create(user: will, session: session6)
UsersSession.create(user: aicha, session: session7)
UsersSession.create(user: paul, session: session7)
UsersSession.create(user: jenny, session: session5)
...
marine_corps_marathon = Event.create(name: 'Marine Corps Marathon', date: 'January 1, 2020', location: 'Washington, DC', distance: 26.2, min_miles_run: 30, min_num_of_sessions: 2)
...
april_fools_10_miler = Event.create(name: 'April Fool\'s Day 10 Miler', date: 'April 1, 2020', location: 'Mars', distance: 10, min_miles_run: 5, min_num_of_sessions: 2)
boston_marathon = Event.create(name: 'Boston Marathon', date: 'May 1, 2020', location: 'Boston, MA', distance: 26.2, min_miles_run: 50, min_num_of_sessions: 2)